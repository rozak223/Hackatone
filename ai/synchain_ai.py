...
if __name__ == "__main__":
    ...
    demo_data_1 = ai.load_local_data('data/data_1.csv')
    demo_data_2 = ai.load_local_data('data/data_2.csv')
    
    data_gabungan = pd.concat([demo_data_1, demo_data_2], ignore_index=True)
    
    # Initialize and train
    X, y, target = ai.preprocess_data(data_gabungan)
